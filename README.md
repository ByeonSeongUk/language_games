...
| 요소 | 색상 | 의미 |
|------|------|------|
| 日 프레임 + 중앙선 | 🔵 블루-시안 | 일본, 신뢰, 학습 |
| 한 (ㅎ 원형 + ㅏ 곡선) | 🔴 레드-코랄 | 한국, 열정 |
| 융합 포인트 | 💜 퍼플-골드 | 두 문화의 만남, 성취 |

- **日의 추상화** — 둥근 사각 프레임 + 가로선 = 한자의 구조미
- **한의 추상화** — 상단 원형(ㅎ) + 흐르는 곡선(ㅏ) = 한글의 조형미
- **겹침과 조화** — 두 문자가 자연스럽게 어우러져 하나의 심볼로
...
- **일본어 발음 TTS** — Web Speech API 음성 지원
